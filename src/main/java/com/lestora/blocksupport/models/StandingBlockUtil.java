...
public class StandingBlockUtil {
    ...
    static EntityBlockInfo getSupportingBlock(Player player, boolean lastBlockSolid) {
    ...
    static @NotNull BlockPos getBlockPos(Player player, Level world, BlockPos supportingPos, int offset, boolean fromWater, boolean lastBlockSolid) {
