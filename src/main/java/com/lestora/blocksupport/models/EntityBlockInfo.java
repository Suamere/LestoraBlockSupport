...
public class EntityBlockInfo {
    ...
    EntityBlockInfo(BlockState supportingBlock, BlockState belowSupport,
    ...
    static EntityBlockInfo fromSupport(BlockState supportState, BlockPos supportPos, boolean lastBlockSolid) {
